...
abstract class AppLocalizations {
  ...
  /// Nome do jogo, exibido em barras de título
  ///
  ...
  /// No description provided for @navSpaceport.
  ///
  /// In pt, this message translates to:
  /// **'Espaçoporto'**
  String get navSpaceport;
  ...
  /// No description provided for @hudCurrency.
  ///
  /// In pt, this message translates to:
  /// **'Fert\$'**
  String get hudCurrency;

  /// No description provided for @hudResourcesLabel.
  ///
  /// In pt, this message translates to:
  /// **'Recursos'**
  String get hudResourcesLabel;
  ...
  /// No description provided for @capitalSlotsSummary.
  ///
  /// In pt, this message translates to:
  /// **'{used} de {total} instituições instaladas'**
  String capitalSlotsSummary(int used, int total);

  /// No description provided for @capitalEmptySlot.
  ///
  /// In pt, this message translates to:
  /// **'Slot livre'**
  String get capitalEmptySlot;

  /// No description provided for @capitalBuildAction.
  ///
  /// In pt, this message translates to:
  /// **'Instalar'**
  String get capitalBuildAction;
